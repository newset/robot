    ...
    <form ng-submit="SIns.cu(SIns.current_row)"
        ...
        <div class="form-group">
            <div class="col-md-2 col-md-offset-10" ng-controller="CPageDepartment as cPageDepartment">
                <button  class="btn-custom  " ng-disabled="form_hospital.$invalid" ng-click="SIns.cu(SIns.current_row)">取消</button>
                <button  class="btn-custom  " ng-disabled="form_hospital.$invalid" ng-click="SIns.cu(SIns.current_row)">确定</button>
            </div>
        </div>
        <br/>
        {{-- <div class="form-group">
