<form ng-submit="SIns.u(SIns.current_row)"
      name="form_mark_update"
      ng-init="SAgency.get_all_rec()"
      ng-controller="CPageMark">
    <div class="form-group">
        {{--[:SIns.current_row:]--}}
        <div class="error form-group">
            <p class="error" ng-if="form_mark_update.mark_list.$error.laRowNumMatch && form_mark_update.mark_list.$touched">编号总数与行数不匹配</p>
            <p class="error" ng-if="form_mark_update.mark_list.$invalid && form_mark_update.$touched">请检查表单输入</p>
    ...
    <div class="form-group">
        ...
        <button type="submit" class="btn btn-primary" ng-disabled="form_mark_update.$invalid">绑定</button>
    </div>
</form>