            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    ...
                    <div class="actions pull-right">
                        <i class="fa fa-chevron-down" i-toggle data-toggle="collapse" data-target="#robot_query"
                ...
                <div class="panel-body">
                    <div role="grid" id="example_wrapper" class="dataTables_wrapperno-footer">
                        <div class="row col-md-12 search_panel">
                            <form class="form-horizontal" ng-class="{'collapse': simpleQuery}" id="robot_query"
                                  aria-expanded="true">
                                ...
                                <div class="form-group md-select-group">
                                    ...
                                    <div class="col-md-3 row">
                                        <select name="provice" class="form-control" chosen
                                    ...
                                    <div class="col-md-3">
                                        <select name="provice" class="form-control" update="SIns.cond.where.province_id"
                                                chosen ng-model="SIns.cond.where.city_id"
                                                ng-options="l.id as l.name for l in SBase._.location.city || []|filter: {parent_id: SIns.cond.where.province_id}:true">
                                            <option value="">不限</option>
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <label class="checkbox-inline" ng-if="lease"
                                           ng-repeat="lease in SIns.robot_status_type"><input type="checkbox"
                                                                                              value="[:lease.id:]"
                                                                                              multi-check
                                                                                              index="[:$index:]"
                                                                                              holder="SIns.cond.where.lease_type_id"/>[:lease.name:]</label>
                                </div>

                                <div class="form-group">
                                    <label class="control-label col-md-1">设备状态</label>
                                    <label class="checkbox-inline" ng-repeat="action in SIns.robot_action_type"><input
                                                type="checkbox" value="[:action.id:]" multi-check index="[:$index:]"
                                                holder="SIns.cond.where.action_type_id"/>[:action.name:]</label>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6 row">
                                        <select name="hospital_id" chosen class="form-control"
                                ...
                                <div class="form-group">
                                    ...
                                    <label class="radio-inline"><input type="radio" value="" ng-true-value=""
                                                                       ng-model="SIns.cond.where.log_action_tid">不限</label>
                                    <label class="radio-inline"><input type="radio" value="1" ng-true-value="1"
                                                                       ng-model="SIns.cond.where.log_action_tid">有维修记录</label>
                                    <label class="radio-inline"><input type="radio" value="0" ng-true-value="0"
                                                                       ng-model="SIns.cond.where.log_action_tid">无维修记录</label>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-3" style="margin-left:-20px; ">
                                        <datepicker date-format="yyyy-MM-dd"
                                                    date-max-limit="[:SIns.cond.where.created_end:]"
                                                    date-set="[:SIns.cond.where.created_start:]">
                                            <input type="text" ng-model="SIns.cond.where.created_start"
                                                   class="form-control">
                                        </datepicker>
                                    </div>
                                    ...
                                    <div class="col-md-3">
                                        <datepicker date-format="yyyy-MM-dd" date-set="[:SIns.cond.where.created_end:]"
                                                    date-min-limit="[:SIns.cond.where.created_start:]">
                                            <input type="text" ng-model="SIns.cond.where.created_end"
                                                   class="form-control ">
                                        </datepicker>
                                    </div>
                                    <div style="display:inline-block">
                                        <button type="button" class="btn btn-default"
                                                ng-click="SIns.cond.where.created_start =null;SIns.cond.where.created_end=null">
                                            清除
                                        </button>
                                    </div>
                                </div>
