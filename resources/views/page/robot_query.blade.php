            ...
            <div class="panel panel-default">
                <div class="panel-heading"  style="height: 60px;" ng-init="showSimpleForm = true">
                    ...
                    <div ng-show="type=='sale'">
                        <form class="form-horizontal" ng-show="showSimpleForm" aria-expanded="true">
                            <div class="col-md-4">
                ...
                <div class="panel-body">
                    <div role="grid" id="example_wrapper" class="dataTables_wrapperno-footer">
                        <form class="form-horizontal" ng-class="{'in': !simpleQuery, 'collapse': simpleQuery}" id="robot_query" aria-expanded="false" style="height: 0px;">
    ...
    <div class="row">
        <div class="col-md-12" ng-show="SIns.total_items != undefined">
            ...
            <div class="pagination_wrapper">
                ...
                <span class="pull-left">记录: [:(SIns.cond.pagination+1-1)* default_paginataion_limit +  (SIns.total_items/SIns.total_items) || 0:] / [:SIns.total_items:]</span>
