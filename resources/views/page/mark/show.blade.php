	...
	<div class="panel panel-default">
		<div class="panel-body">
			...
			<div class="pull-right" ng-init="agency =-1">
				...
				<button type="button" class="btn btn-primary no-animate" ng-click="unbind()" ng-show="SIns.current_row.status==1 && SIns.current_row.agency_id != -1 && SIns.current_row.hospital_id == -1">解绑</button>
